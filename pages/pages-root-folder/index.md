...
widget1:
  title: "Lotus"
  url: '/projects/lotus-lang'
  image: projects/lotus-thumb.png
  text: "A statically-typed procedural programming language with an interpreter built in C++."
widget2:
  title: "Nyctomorph"
  url: '/projects/nyctomorph'
  image: projects/nyctomorph-thumb.png
  text: "Nyctomorph is a short survival adventure game in which the player has to survive the night, alone in a dark forest, with only a campfire and a handful of twigs scattered about. Don't stray far from the light... who knows what could be lurking about?"
